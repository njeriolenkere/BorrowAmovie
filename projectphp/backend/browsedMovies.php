...
<h3>Search Movie</h3>
<hr>
You may search by title, or by producer, or both<br>
...
<h3>Movie List</h3><p><a href="addmovie.php">+ new movie</a></p>
<hr>
<?php
...
# Here's the query using bound result parameters
    ...
    $stmt->bind_result($movieid, $title, $make, $producer, $year, $gerne, $onloan);//whatever you is assigned in query(SHOULD BE TRANSLATED) then brought here and prepares it for execution. 
    ...
    echo '<tr><th>ID</th> <th>Title</th> <th>Make</th> <th>Producer</th> <th>Year</th> <th>Gerne</th><th>Reserved?</th> </tr>';
    ...
    while ($stmt->fetch()) {
        ...
        echo "<tr>";
        echo "<td>$movieid</td> <td> $title </td><td>$make</td><td> $producer </td> <td>$year</td> <td>$gerne</td> <td>$onloan</td>";
